    ...
    return (
      <div className="resume">
        ...
        <Item name={"Institute Barcelona d'Estudis Internacionals"}
              ...
              tasks={[
                      'My thesis covered the nuances of social capital development in relation to Internet use, particularly among immigrant communities, given that Internet utilization has become culturally ubiquitous in much of the developed world.'
                      ]}
        />
